...
namespace Xunit.Sdk
{
    ...
    public class UITheoryTestCaseRunner : UITestCaseRunner
    {
        ...
        internal UITheoryTestCaseRunner(IXunitTestCase testCase,
                                         string displayName,
                                         string skipReason,
            ...
            : base(testCase, displayName, skipReason, constructorArguments, NoArguments, messageBus, aggregator, cancellationTokenSource, syncContextAdapter)
        {
